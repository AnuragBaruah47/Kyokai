...
const EachAnime = () => {
  ...
  return (
    <div className="min-h-screen flex bg-black gap-[150px] text-white top-[150px] relative w-[100vw]">
      <div className="flex w-auto ml-[60px] gap-[30px]">
        ...
        <div>
          <div className="text-[16px] flex font-[900] font-mono">
            ...
            {response?.type && <span className="ml-2">| {response.type}</span>}
            {response?.title && (
          ...
          <div className="mt-[20px] h-[33px] w-[163px]">
            <button className="h-[30px] border border-white w-[160px] bg-[#676666] hover:text-green-300 transition-all ease-in-out text-white rounded-[5px] font-mono mt-[10px] font-[900]">
              Add to Bookmark
            </button>
          </div>
      ...
      <div className="h-auto w-[350px]  mr-[30px] text-[17px] font-mono">
        {response?.title_japanese && <div>Name: {response.title_japanese}</div>}
        ...
        {response?.popularity && <div>Popularity: #{response.popularity}</div>}
        ...
        {response?.trailer?.embed_url && (
          <div className="flex h-[182px] w-[330px] justify-center items-center mt-[20px] border border-white p-[10px]">
            <iframe
              width="320"
              height="180"
